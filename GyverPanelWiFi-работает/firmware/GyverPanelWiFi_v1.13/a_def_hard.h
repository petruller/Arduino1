...
#define HEIGHT 15              // высота одного сегмента матрицы для MATRIX_TYPE == 0 или MATRIX_TYPE == 1                                       | для MATRIX_TYPE == 2 ПОЛНАЯ ВЫСОТА матрицы 
...
#define LED_PIN  D4              // D2 физческий пин ленты: укажите здесь 2 (это GPIO2 или D4) для ядра 2.7.4 и выбранной платы NodeMCU v1.0 (ESP12-E) вывод все равно будет переназначен ядром на D2
#define PIN_BTN D1              // D4 кнопка подключена сюда (D4 --- КНОПКА --- GND) 
