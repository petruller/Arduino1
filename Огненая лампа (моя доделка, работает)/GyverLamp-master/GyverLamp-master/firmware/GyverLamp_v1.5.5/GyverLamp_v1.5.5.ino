...
// ---------- МАТРИЦА ---------
#define BRIGHTNESS 30         // стандартная маскимальная яркость (0-255)
...
// 0 - точка доступа
// 1 - локальный
byte IP_AP[] = {192, 168, 0, 66};   // статический IP точки доступа (менять только последнюю цифру)
...
// -------- Менеджер WiFi ---------
#define AC_SSID "TP-Link_Dimon"
#define AC_PASS "55556666"
...
void setup() {
  ...
  currentMode = 1;// (int8_t)EEPROM.read(200); //МОООООООООООООЙ огонь при включении //=1;
