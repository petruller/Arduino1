...
const char* ssid     = "TP-LINK_FA21AA";
const char* password = "rellurtep12";
...
const int output5 = 13;//d7
const int output4 = 12;//d6
...
if (millis() - nasOnTime > 10000 && nasos==false) 
{
          ...
          if (currentLine.length() == 0) {
           ...
           if (0<=rotate<=180)
           {
            ...
            if (output4State=="off") {
             ...
             if (output7State=="off") {
              client.println("<p><a href=\"/7/on90\"><button class=\"button\">CLICK</button></a></p>");
            } else {
              client.println("<p><a href=\"/7/on90\"><button class=\"button\">CLICK</button></a></p>");
            }
             if (output8State=="off") {
