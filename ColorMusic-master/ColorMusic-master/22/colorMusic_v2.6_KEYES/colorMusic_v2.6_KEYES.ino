...
// ----- КНОПКИ ПУЛЬТА -----
#define BUTT_UP     0xE207E1AD
#define BUTT_DOWN   0x4E5BA3AD

#define BUTT_LEFT   0x517068AD
#define BUTT_RIGHT  0x1B92DDAD
#define BUTT_OK     0xAC2A56AD
#define BUTT_1      0x18319BAD
#define BUTT_2      0xF39EEBAD
#define BUTT_3      0x00FF7A85
#define BUTT_4      0x00FF10EF
#define BUTT_5      0x00FF38C7
#define BUTT_6      0x00FF5AA5
#define BUTT_7      0x00FF42BD
#define BUTT_8      0x00FF4AB5
#define BUTT_9      0x00FF52AD
#define BUTT_0      0x00FF6897
#define BUTT_STAR   0x00FF9867
#define BUTT_HASH   0x00FFB04F
// ----- КНОПКИ ПУЛЬТА -----
// ------------------------------ ДЛЯ РАЗРАБОТЧИКОВ --------------------------------
...
void mainLoop() {
  ...
  if (ONstate) {
    if (millis() - main_timer > MAIN_LOOP) {
      ...
      if (!irrecv.decode( &results ))    // если на ИК приёмник не приходит сигнал (без этого НЕ РАБОТАЕТ!)
